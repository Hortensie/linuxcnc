...
import linuxcnc
import hal, hal_glib
from qtvcp.widgets.dragon_probe import Probe as PRBASIC
...
class HandlerClass:
    def __init__(self, halcomp, widgets, paths):
        ...
        self.PROBE = PRBASIC(halcomp, widgets)
...
# some global variables
    ...
    def initialized__(self):
        ...
        self.PROBE.init_hal_pins()
        self.PROBE.init_widgets()
        self.w.stackedWidget_log.setCurrentIndex(0)
        self.w.gcode_stacked_widget.setCurrentIndex(0)
...
#                    QtCore.Qt.Key_F3,QtCore.Qt.Key_F4,QtCore.Qt.Key_F5):
    ...
    def btn_touchoff_clicked(self):
        ...
        self.show_jogz_dialog(max_probe)
    ...
    def show_jogz_dialog(self, max_probe):
        s = "Jog Z to within {} mm above workpiece".format(max_probe)
        mess = {'NAME':'MESSAGE','ID':'_touchoff_',
            'TITLE':'QtDragon',
